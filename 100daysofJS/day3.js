/*
Q.  Write a function called countChar that takes two parameters: a string and a character to count. The function should return the number of items the specified character appears in the string.
Constraints:
